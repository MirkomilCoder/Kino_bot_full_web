...
export default function OwnerDashboard({ user }: OwnerDashboardProps) {
  const [activeTab, setActiveTab] = useState<'stats' | 'movies' | 'users' | 'support' | 'channels' | 'broadcast'>(
    'stats'
  );
  ...
  return (
    <div className="min-h-screen bg-light">
      <Header title="Панель владельца" subtitle="Полное управление системой" user={user} onLogout={handleLogout} />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="animate-fadeIn">
          {activeTab === 'stats' && <OwnerStats token={token} />}
